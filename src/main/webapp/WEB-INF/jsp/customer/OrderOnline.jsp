...
<html>
    ...
    <body>
        ...
        <div class="container">
            ...
            <div id="messageBox" style="display:none; padding:10px; border-radius:6px; margin:10px 0;"></div>
                    ...
                    <tbody>
                        <c:forEach var="p" items="${products}">
                            <tr>
                                ...
                                <td>${p.quantity}</td>
                                <td>
                                    <input type="number" id="qty-${p.id}" min="1" max="${p.quantity}" value="1" required/>
                                </td>
                                <td>
                                    <button type="button" class="btn small" onclick="addToCart(${p.id})">Add to Cart</button>
                                </td>
                            </tr>
                        </c:forEach>
                    </tbody>
