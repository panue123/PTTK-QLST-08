...
CREATE TABLE tblAddress (
  ...
  country VARCHAR(255),
  FOREIGN KEY (customerId) REFERENCES tblCustomer(userId) ON DELETE CASCADE
);
...
CREATE TABLE tblOnlineOrder (
  ...
  FOREIGN KEY (addressId) REFERENCES tblAddress(id)
);
...
CREATE TABLE tblOrderDetail (
  ...
  FOREIGN KEY (onlineOrderId) REFERENCES tblOnlineOrder(id) ON DELETE CASCADE,
  FOREIGN KEY (productId) REFERENCES tblProduct(id)
);

DELETE FROM `tblUser` WHERE username IN ('admin', 'user');
INSERT INTO `tblUser` (id, username, password, phone, email, fullName, role) VALUES
(1, 'admin', '$2a$12$gg3BQ1dh9K26H3ywr.RWSuVmbbNh6wlno9Hd7xilgxa.mkiPp1gNK', '0123456789', 'admin@example.com', 'Phan Ánh Nguyệt', 'ADMIN'),
(2, 'user',  '$2a$12$gg3BQ1dh9K26H3ywr.RWSuVmbbNh6wlno9Hd7xilgxa.mkiPp1gNK', '0987654321', 'user@example.com',  'Lê Minh',  'CUSTOMER');
INSERT INTO tblCustomer (userId) VALUES (2);

INSERT INTO tblProduct (id, name, description, price, quantity) VALUES
...
INSERT INTO tblAddress (id, customerId, street, province, country) VALUES
